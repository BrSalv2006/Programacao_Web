...
function avaliarFalhasSensor(medicao) {
	const problemas = []
...
function avaliarCondicoesPlano(medicao, condicoes = {}) {
	const problemas = []
...
function escolherAcaoAutomacao(problemas) {
...
router.patch('/alertas/:id', requireRole('Administrador', 'Responsável'), async (req, res, next) => {
	try {
